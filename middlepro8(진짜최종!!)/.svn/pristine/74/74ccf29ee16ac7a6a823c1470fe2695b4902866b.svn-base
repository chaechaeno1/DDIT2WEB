...
#joinForm {
	...
	box-shadow: 0px 0px 5px 2px #d6d46d;
}
...
/* 버튼 적용되는 부분의 CSS를 클래스로 줬어야 하는데 ID로 주어서 스크립트까지 오류나는 불상사를... 죄송합니다..ㅠ */
.joinbtn{
	padding: 7px 10px;
    background: #f1f0cb;
    border: none;
...
<section id="joinDiv">
  ...
  <form id="joinForm">
    ...
    <div>
      ...
      <input type="button" value="중복검사" class="btn btn-success btn-sm joinbtn">
    ...
    <div>
      ...
      <input type="button" value="우편번호 찾기" class="btn btn-success btn-sm  joinbtn" id="zipBtn">
    </div>
	...
	<div id="bottomBtn">
	  <button type="button" class="btn btn-primary btn-lg joinbtn" id="joinBtn">회원가입</button>
      <button type="reset" class="btn btn-primary btn-lg joinbtn">초기화</button>
	</div>
