...
<div class="infoIframeDiv">
  ...
  <form id="infoUpdateForm">
    <div>
      ...
      <input type="text" class="form-control" id="id" name="mem_id" value="여기 이름 넣어요" readonly>
    </div>
    
     <div>
      <label for="new_pwd">새 비밀번호</label>
      <input type="password" class="form-control" id="new_pwd" name="mem_pass">
    </div>
    
    <div>
      <label for="new_pwdconfirm">새 비밀번호 확인</label>
      <input type="password" class="form-control" id="new_pwdconfirm">
      <span id="pwdcheck"></span>
    </div>
  
    <div>
      <label for="name">이름</label>
      <input type="text" class="form-control" id="name" name="mem_name" value="여기 이름 넣어요" readonly>
    </div>
      
    <div>
      <label for="bir">생년월일</label>
      <input type="date" class="form-control" id="bir" name="mem_bir" value="여기 날짜 넣어요" readonly>
    </div>
    
    <div>
      <label for="hp">연락처</label>
      <input type="text" class="form-control" id="hp" name="mem_hp" value="여기 연락처 넣어요">
    </div>
