...
<body>
	...
	<div class="reservationDiv">
	  ...
	  <div id="resbutton">
        <a href="adminResMainCal.jsp" class="resbtn" id="resG" target="if_adminrescal">글램핑 예약확인</a>
        <a href="adminResMainCal.jsp" class="resbtn" id="resA" target="if_adminrescal">오토캠핑 예약확인</a>
        <a href="adminResMainCal.jsp" class="resbtn" id="resC" target="if_adminrescal">카라반 예약확인</a>
      </div>
      
      <iframe src="adminResMainCal.jsp" name="if_adminrescal"></iframe>
